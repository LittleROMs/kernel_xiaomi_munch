...
KBUILD_CFLAGS   += -O3 -march=armv8.2-a+lse+crypto -fno-trapping-math -fno-math-errno -mllvm -polly --cuda-path=/dev/null
KBUILD_AFLAGS   += -O3 -march=armv8.2-a+lse+crypto
